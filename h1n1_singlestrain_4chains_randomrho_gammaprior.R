...
# Set initial values:
#ini_1 = function(){
#  list(theta=c(runif(1,0,6),runif(1,0.01,3)), 
#       S0=runif(1,0.9,0.99))  
#}
#ini_1 = function(){
...
#}
ini_1 = function(){
	list(theta=c(runif(1,5.7,5.9),runif(1,5.5,5.7)), 
	      S0=runif(1,0.99,0.999),rho=runif(1,75,85))
}
parameters = c("y_hat", "y_init", "theta",  "R_0","rho")
...
nuts_fit_1 = sampling(m1, data = flu_data, init = ini_1, chains = n_chains, warmup = n_warmups, iter = n_iter, thin=n_thin, seed=13219,
					sample_file="singlestrainh1n1_samples.csv",diagnostic_file="singlestrainh1n1_diagnostic.csv")
saveRDS(nuts_fit_1, "h1n1_singlestrain_RRfit_gp4chains.RDS")
...
pdf("4chains trace and pairs plots 1 strain randomrho gp.pdf")
